...
\end{center}
\textbf{Interpretation:} The fine-tuned VGG16 model shows rapid convergence, reaching 96\% training accuracy, while validation plateaus at $\sim$70\%. This indicates that while transfer learning accelerates learning, the model still overfits without heavy regularization.

\vspace{5mm}
\begin{center}
    \includegraphics[width=0.75\textwidth]{train_val_loss.eps}
\end{center}
\textbf{Interpretation:} The training loss drops near zero, but validation loss diverges and increases after epoch 4. In the context of our fine-tuning experiment, this confirms that training for too many epochs degrades generalization on small datasets.
